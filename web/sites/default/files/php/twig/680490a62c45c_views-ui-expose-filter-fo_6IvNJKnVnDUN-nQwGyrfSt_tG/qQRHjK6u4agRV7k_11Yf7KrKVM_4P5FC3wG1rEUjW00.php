...
class __TwigTemplate_d96df1575ffd3921b7ac10cc222683c0 extends Template
{
...
";
        // line 67
        if ((($_v0 = CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "operator", [], "any", false, false, true, 67)) && is_array($_v0) || $_v0 instanceof ArrayAccess && in_array($_v0::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v0["#type"] ?? null) : CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["form"] ?? null), "operator", [], "any", false, false, true, 67), "#type", [], "array", false, false, true, 67))) {
            // line 68
...
";
    ...
    {
        return new Source("", "core/themes/claro/templates/views/views-ui-expose-filter-form.html.twig", "/opt/lampp/app/rekod4sekolah/web/core/themes/claro/templates/views/views-ui-expose-filter-form.html.twig");
    }
